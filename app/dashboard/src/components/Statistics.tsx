...
export const Statistics: FC<BoxProps> = (props) => {
  ...
  const hasQuota =
    ...
    getUserIsSuccess &&
    !userData.is_sudo &&
    userData.creation_quota_bytes !== null &&
    userData.creation_quota_bytes !== undefined;
  ...
  return (
    <Box {...props}>
      ...
      {hasQuota && (
        <Box mt={4}>
          <QuotaCard
            allocated={userData.allocated_quota_bytes}
            quotaLimit={userData.creation_quota_bytes as number}
          />
        </Box>
      )}
    </Box>
